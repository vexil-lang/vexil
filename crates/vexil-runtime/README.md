...
| `BitReader::read_remaining()` | Align to the next byte boundary and consume every byte left in the current reader. Callers must scope the reader to the payload they intend to consume. |
