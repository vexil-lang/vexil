...
Generated messages carry an `_unknown` field, but decoders do not populate it -- it is empty after every decode. Vexil does not currently provide lossless unknown-field round-tripping.
