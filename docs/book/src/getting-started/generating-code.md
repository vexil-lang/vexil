...
Rust and TypeScript generated paths have broad cross-language byte-vector
coverage. Generated Go and Python are verified against a representative shared
wire matrix; verify application-specific schemas and environments separately.
