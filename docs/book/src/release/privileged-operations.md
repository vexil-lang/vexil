...
<a id="rbr-008"></a>
<a id="rbr-009"></a>
| privileged-operation-rbr-003 | RBR-003 | assignment-release-steward-2026-07-14 | release-manifest-bound-tag | contents:write:refs/tags/exact-approved-manifest-tag | verified external controls absent; registry identity and custody unresolved; later immutable candidate inputs absent | Release Steward retains the visible blocking procedure; no fallback may create, move, or delete a tag. |
| privileged-operation-rbr-004 | RBR-004 | assignment-release-steward-2026-07-14 | release-unit:exact-approved-manifest-entry | publish:exact-approved-release-unit | verified external controls absent; registry identity and custody unresolved; release authorization evidence absent; later immutable candidate inputs absent | Release Steward retains the visible blocking procedure; no fallback may publish a package, release, artifact, or deployment. |
