...
| Consider retirement | `repository-administrator` | defer | retire a responsibility through this fallback | separately reviewed public retirement decision required by `advisory-automation.md` | Story 1.4 accepted retirement path | No separately reviewed and approved retirement decision | `repository-administrator` | yes |

This fallback never becomes a privileged path. Advisory identity and permission verification remain an **unverified Epic 2 blocker**; retirement is outside this exercise and requires Story 1.4's separate public decision.
