...
| Documentation workflow and environment | `.github/workflows/docs.yml`, `github-pages` | `repository-administrator` | target-specific workflow and environment observation | main-only documentation deployment is separate from release controls |
...
Actual provider-side stopping or revocation is deliberately not exercised here. It remains an **unverified external-control blocker** until verified target controls are recorded.
