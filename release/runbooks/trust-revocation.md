...
GitHub Actions, environment, registry, and administrator recovery controls remain **unverified external-control blockers** until Vexil records target evidence. This tabletop record preserves the response path; it does not claim revocation was tested or compliant.
