...
The current single-maintainer assignment remains an unresolved continuity gate. It blocks Manifest approval and privileged publication. Provider-side administrator recovery is an **unverified external-control blocker**, not an exercised control.
