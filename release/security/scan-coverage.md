...
`release/security/scans/npm-runtime-ts-2026-07-25.json`. The selected Go
runtime has source-mode, symbol-level `govulncheck` evidence at
`release/security/scans/go-runtime-go-2026-07-26.md`. Cargo, Python, and
GitHub Actions remain coverage gaps, not exclusions: each has an owner,
