...
Zero dependencies. ESM-only. Node >= 22.12.
...
The checked-in source version can differ from the published npm version. Choose and pin a published version after checking its compatibility with your generated code.
